...
- [ ] Centralize capabilities using verified device type, variant, generation,
...
- [ ] SensorControl: P0/P005 values 1/2/3; P005GA/P14 values 0/1/2/3/4.
  Preserve the wire meanings; do not renumber by UI index.
- [ ] Starting points: 3 versus 5; expose points 4/5 where supported and include
...
- [ ] Drive Past Wire ranges: P0 20–40, P005/P005GA 20–35, P14 25–40 cm.
- [ ] Station starting distance: P0 20–300, others 60–300 cm; preserve mm scaling.
...
- [ ] ZoneProtect and CorridorCut: P0 main-version-prefix boundary 41; validate
  version parsing, short/malformed versions and unknown behavior. Never probe writes.
- [ ] Brand-specific availability such as the McCulloch Frost UI exclusion.
